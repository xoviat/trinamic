...
impl<T: TMCLConnnection> TMCLInterface<T> {
    ...
    async fn read_mc(&mut self, register_address: u8, module_id: Option<u16>, signed: bool) -> u32 {
    ...
    async fn read_drv(&mut self, register_address: u8, module_id: Option<u16>, signed: bool) -> u32 {
