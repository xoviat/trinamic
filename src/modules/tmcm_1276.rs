...
impl<T: TMCLConnnection> TMCM_1276<T> {
    ...
    pub async fn get_axis_parameter(&mut self, ap_type: _AP) -> u32 {
        self.connection
    ...
    pub async fn get_global_parameter(&mut self, gp_type: u8, bank: u8) -> u32 {
        self.connection
    ...
    //
    pub async fn get_max_current(&mut self) -> u32 {
    ...
    pub async fn get_target_position(&mut self) -> u32 {
    ...
    //
    pub async fn get_actual_position(&mut self) -> u32 {
    ...
    //
    pub async fn get_target_velocity(&mut self) -> u32 {
    ...
    //
    pub async fn get_actual_velocity(&mut self) -> u32 {
        self.get_axis_parameter(_AP::ActualVelocity).await
    }
    //
    pub async fn get_max_velocity(&mut self) -> u32 {
    ...
    //
    pub async fn get_max_acceleration(&mut self) -> u32 {
